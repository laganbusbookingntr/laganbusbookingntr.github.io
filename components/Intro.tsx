...
const Intro: React.FC<IntroProps> = ({ onFinish }) => {
  ...
  return (
    <div 
      className={`fixed inset-0 z-[100] flex flex-col items-center justify-center bg-slate-950 transition-transform duration-[500ms] ease-[cubic-bezier(0.76,0,0.24,1)] ${
